      ...
      <header className="flex items-center justify-between px-6 py-5 md:px-12 border-b border-slate-100 bg-white sticky top-0 z-50">
        <div className="flex items-center gap-10">
          ...
          <nav className="hidden md:flex gap-8 font-bold text-sm mt-1">
            <Link href="/dashboard" className="text-orange-600 border-b-2 border-orange-600 pb-1">
              Beranda
            </Link>
            <Link href="/menu" className="text-slate-400 hover:text-slate-900 transition-colors pb-1">
              Daftar Menu
            </Link>
            <Link href="/reservasi" className="text-slate-400 hover:text-orange-500 transition-colors pb-1 flex items-center gap-1">
              Reservasi Meja <span className="bg-orange-100 text-orange-600 text-[9px] px-1.5 py-0.5 rounded-full">NEW</span>
            </Link>
          </nav>
        </div>
        ...
        <div className="flex items-center gap-5">
          <div className="text-right hidden sm:block">
            <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest">Selamat Datang,</p>
      ...
      <main className="max-w-7xl mx-auto px-6 md:px-12 py-12 md:py-20 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        ...
        <div className="space-y-6">
          ...
          <h2 className="text-5xl lg:text-7xl font-black text-slate-900 leading-[1.05] tracking-tight">
            Kehangatan <br /> Rasa <br /> Kuliner <span className="text-orange-600">Sinar <br/> Remaja</span>.
          </h2>
          
          <p className="text-slate-500 text-base md:text-lg max-w-md leading-relaxed mt-4">
            Halo <strong className="text-slate-800">{username}</strong>, nikmati hidangan legendaris dengan cita rasa otentik yang diproses higienis dan cepat langsung dari dapur utama kami.
          </p>
        ...
        <div className="bg-gradient-to-br from-orange-500 to-orange-600 rounded-[3rem] p-10 md:p-12 text-center text-white shadow-2xl shadow-orange-600/20 flex flex-col justify-center items-center aspect-square lg:aspect-auto lg:h-[550px] relative overflow-hidden group">
          ...
          <div className="text-7xl mb-6 drop-shadow-md z-10 animate-bounce">🍛</div>
          <h3 className="text-3xl md:text-4xl font-black mb-4 tracking-tight z-10">Sinar Remaja Resto</h3>
          <p className="text-orange-100/90 leading-relaxed max-w-sm font-medium z-10">
            Kombinasi resep warisan asli dan sistem pemesanan modern berbasis API terintegrasi.
          </p>
        </div>
